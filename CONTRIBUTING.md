...
Thank you for your interest in `walletwall-holder-wall`.
...
- Bug fixes in the Holder Wall surface
...
See `docs/PUBLIC_SAFE_SCOPE.md` for the full exclusion list. In summary: no secrets, no live Dune execution, no wallet connections, no signing or transaction logic, no vault write flows, no real holder addresses.
...
- [ ] Demo addresses are clearly marked as fake
